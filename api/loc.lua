...
ArrowAPI.loc.add_loc_text_func(ArrowAPI, function()
    ...
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_tarot', {['en-us'] = 'Tarot'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_planet', {['en-us'] = 'Planet'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_spectral', {['en-us'] = 'Spectral'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_background', {['en-us'] = 'Background'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_hearts', {['en-us'] = 'Hearts'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_spades', {['en-us'] = 'Spades'})
    ...
    SMODS.process_loc_text(G.localization.misc.dictionary, 'palette_bkg_endless', {['en-us'] = 'Endless'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_arrow_pal_clubs', {['en-us'] = 'Clubs'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_apply_palette', {['en-us'] = 'Apply'})
    SMODS.process_loc_text(G.localization.misc.dictionary, 'b_copy_palette', {['en-us'] = 'Copy'})
    ...
    SMODS.process_loc_text(G.localization.misc.dictionary, 'tnsmi_manager_pause', {['en-us'] = 'Soundpack Manager'})
