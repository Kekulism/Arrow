...
SMODS.Joker:take_ownership('j_chicot', {
    atlas = Cardsauce and 'csau_jokers' or nil,
    prefix_config =  Cardsauce and {atlas = false} or nil,
    pos = Cardsauce and {x = 4, y = 15} or nil,
    soul_pos = Cardsauce and {x = 5, y = 15} or nil,
    calculate = function(self, card, context)
...
local path = ArrowAPI.path..(ArrowAPI.custom_path or '')
SMODS.Atlas({key = 'arrow_tarots', custom_path = path, path = 'tarots.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'arrow_planets', custom_path = path, path = 'planets.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'arrow_spectrals', custom_path = path, path = 'spectrals.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'arrow_tags', custom_path = path, path = 'tags/tags.png', px = 34, py = 34, prefix_config = {key = {mod = false}}})

SMODS.Atlas({key = 'arrow_hearts', custom_path = path, path = 'hearts.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'arrow_spades', custom_path = path, path = 'spades.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'arrow_diamonds', custom_path = path, path = 'diamonds.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'arrow_clubs', custom_path = path, path = 'clubs.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})

-- alllllll the collab atlases
SMODS.Atlas({key = 'collab_AC_1', custom_path = path, path = 'collabs/collab_AC.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_AU_1', custom_path = path, path = 'collabs/collab_AU.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_BUG_1', custom_path = path, path = 'collabs/collab_BUG.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_C7_1', custom_path = path, path = 'collabs/collab_C7.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_CL_1', custom_path = path, path = 'collabs/collab_CL.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_CR_1', custom_path = path, path = 'collabs/collab_CR.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_CYP_1', custom_path = path, path = 'collabs/collab_CYP.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_D2_1', custom_path = path, path = 'collabs/collab_D2.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_DBD_1', custom_path = path, path = 'collabs/collab_DBD.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_DS_1', custom_path = path, path = 'collabs/collab_DS.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_DTD_1', custom_path = path, path = 'collabs/collab_DTD.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_EG_1', custom_path = path, path = 'collabs/collab_EG.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_FO_1', custom_path = path, path = 'collabs/collab_FO.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_PC_1', custom_path = path, path = 'collabs/collab_PC.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_R_1', custom_path = path, path = 'collabs/collab_R.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_SK_1', custom_path = path, path = 'collabs/collab_SK.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_STP_1', custom_path = path, path = 'collabs/collab_STP.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_STS_1', custom_path = path, path = 'collabs/collab_STS.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_SV_1', custom_path = path, path = 'collabs/collab_SV.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_TBoI_1', custom_path = path, path = 'collabs/collab_TBoI.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_TW_1', custom_path = path, path = 'collabs/collab_TW.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_VS_1', custom_path = path, path = 'collabs/collab_VS.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_WF_1', custom_path = path, path = 'collabs/collab_WF.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
SMODS.Atlas({key = 'collab_XR_1', custom_path = path, path = 'collabs/collab_XR.png', px = 71, py = 95, prefix_config = {key = {mod = false}}})
