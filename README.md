...
Once Lovely and Steamodded are installed, download the [latest release](https://github.com/Kekulism/Arrow/releases/tag/v1.0.2) and extract the `Arrow-1.0.2` folder into your mods directory. You're all set!
